...
# Audio Codec - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN AB1 [get_ports AC_ADR0];  # "AC-ADR0" I2C Address Bit 0
set_property PACKAGE_PIN Y5  [get_ports AC_ADR1];  # "AC-ADR1" I2C Address Bit 1
set_property PACKAGE_PIN Y8  [get_ports AC_GPIO0];  # "AC-GPIO0" Serial Data DAC Input 
set_property PACKAGE_PIN AA7 [get_ports AC_GPIO1];  # "AC-GPIO1" Serial Data ADC Output
set_property PACKAGE_PIN AA6 [get_ports AC_GPIO2];  # "AC-GPIO2" Bit Clock
set_property PACKAGE_PIN Y6  [get_ports AC_GPIO3];  # "AC-GPIO3" Left-Right Clock
set_property PACKAGE_PIN AB2 [get_ports AC_MCLK];  # "AC-MCLK" CODEC Master Clock
set_property PACKAGE_PIN AB4 [get_ports AC_SCK];  # "AC-SCK" I2C Serial Clock
set_property PACKAGE_PIN AB5 [get_ports AC_SDA];  # "AC-SDA" I2C Serial Data
